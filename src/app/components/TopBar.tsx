  ...
  return (
    <header className="top-bar">
      <div className="search" role="search">
        ...
        <label className="sr-only" htmlFor="workspace-search">Search Clipboard and Library</label>
        <input id="workspace-search" type="search" placeholder="Search Clipboard and Library" autoComplete="off" value={query}
