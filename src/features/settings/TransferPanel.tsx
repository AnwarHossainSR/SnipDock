...
const fieldClass = "w-full rounded-sm border border-border bg-muted px-3 py-2 text-sm font-normal text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring";
